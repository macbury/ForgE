...
void main() {
  ...
  float blurSize = u_blurPower;

  //sum += texture2D(u_downSampledMainTexture, vec2(v_texCoords.x, v_texCoords.y - 4.0*blurSize)) * 0.05;
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x, v_texCoords.y - 3.0*blurSize)) * 0.09;
  //sum += texture2D(u_downSampledMainTexture, vec2(v_texCoords.x, v_texCoords.y - 2.0*blurSize)) * 0.12;
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x, v_texCoords.y - blurSize)) * 0.15;
  ...
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x - 4.0*blurSize, v_texCoords.y)) * 0.05;
  //sum += texture2D(u_downSampledMainTexture, vec2(v_texCoords.x - 3.0*blurSize, v_texCoords.y)) * 0.1;
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x - 2.0*blurSize, v_texCoords.y)) * 0.12;
  //sum += texture2D(u_downSampledMainTexture, vec2(v_texCoords.x - blurSize, v_texCoords.y)) * 0.15;
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x, v_texCoords.y)) * 0.16;
  //sum += texture2D(u_downSampledMainTexture, vec2(v_texCoords.x + blurSize, v_texCoords.y)) * 0.15;
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x + 2.0*blurSize, v_texCoords.y)) * 0.12;
  //sum += texture2D(u_downSampledMainTexture, vec2(v_texCoords.x + 3.0*blurSize, v_texCoords.y)) * 0.1;
  sum += texture2D(u_mainTexture, vec2(v_texCoords.x + 4.0*blurSize, v_texCoords.y)) * 0.05;
