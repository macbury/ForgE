...
public class MainWindow extends JFrame implements ForgEBootListener, FocusListener, WindowFocusListener, Thread.UncaughtExceptionHandler {
  ...
  private JPanel inspectorContainerPanel;
  ...
  public MainWindow() {
    ...
    mainMenu = new MainMenu(projectController, blocksController);
    ...
    toolsController.register(eventsToolsController, 3);
  ...
  private void $$$setupUI$$$() {
    ...
    toolsPane.addTab("", new ImageIcon(getClass().getResource("/icons/node_root.png")), scrollPane1);
    mapTree = new JTree();
    mapTree.setRootVisible(true);
    mapTree.setShowsRootHandles(true);
    mapTree.putClientProperty("JTree.lineStyle", "");
    scrollPane1.setViewportView(mapTree);
    final JPanel panel1 = new JPanel();
    panel1.setLayout(new BorderLayout(0, 0));
    toolsPane.addTab("", new ImageIcon(getClass().getResource("/icons/soil_layers.png")), panel1, "Terrain");
    ...
    panel1.add(terrainToolsToolbar, BorderLayout.NORTH);
    ...
    scrollPane2.setViewportView(blockList);
    final JPanel panel2 = new JPanel();
    panel2.setLayout(new GridBagLayout());
    panel2.setFocusCycleRoot(true);
    panel2.setMinimumSize(new Dimension(0, 34));
    panel2.setPreferredSize(new Dimension(60, 48));
    ...
    panel3.add(panelSecondaryBlock, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    ...
    panel3.add(panelPrimaryBlock, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    panelPrimaryBlock.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLoweredBevelBorder(), null));
    final JPanel panel4 = new JPanel();
    panel4.setLayout(new BorderLayout(0, 0));
    toolsPane.addTab("", new ImageIcon(getClass().getResource("/icons/places.png")), panel4, "Objects");
    final JPanel panel5 = new JPanel();
    panel5.setLayout(new BorderLayout(0, 0));
    toolsPane.addTab("", new ImageIcon(getClass().getResource("/icons/ice_cube.png")), panel5, "Events");
    list1 = new JList();
