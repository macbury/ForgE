...
public class MainWindow extends JFrame implements ForgEBootListener, FocusListener, WindowFocusListener, Thread.UncaughtExceptionHandler {
  ...
  public MainWindow() {
    ...
    terrainToolsController = new TerrainToolsController(terrainToolsToolbar, blocksController, inputProcessor, brushPropertiesPanel);
  ...
  private void $$$setupUI$$$() {
    ...
    brushPropertiesPanel = new JPanel();
    brushPropertiesPanel.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1));
    panel2.add(brushPropertiesPanel, BorderLayout.NORTH);
    comboBox1 = new JComboBox();
    brushPropertiesPanel.add(comboBox1, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    spinner1 = new JSpinner();
    brushPropertiesPanel.add(spinner1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
